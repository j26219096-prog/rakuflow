...
> _Coming soon — run the pipeline and add screenshots here._

| Dashboard Overview | Daily GMV Trend | Top Sellers |
|---|---|---|
| `screenshots/dashboard.png` | `screenshots/gmv_trend.png` | `screenshots/top_sellers.png` |
